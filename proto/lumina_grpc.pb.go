...
const (
	...
	Lumina_SyncIndex_FullMethodName            = "/lumina.Lumina/SyncIndex"
	Lumina_FullResyncIndex_FullMethodName      = "/lumina.Lumina/FullResyncIndex"
	...
	Lumina_SetDriveCloudreve_FullMethodName    = "/lumina.Lumina/SetDriveCloudreve"
	Lumina_ListDriveCloudrveDir_FullMethodName = "/lumina.Lumina/ListDriveCloudrveDir"
...
type LuminaClient interface {
	...
	FullResyncIndex(ctx context.Context, in *FullResyncIndexRequest, opts ...grpc.CallOption) (*FullResyncIndexResponse, error)
	...
	// Cloudreve Drive
	SetDriveCloudreve(ctx context.Context, in *SetDriveCloudrveRequest, opts ...grpc.CallOption) (*SetDriveCloudrveResponse, error)
	ListDriveCloudrveDir(ctx context.Context, in *ListDriveClourdreveDirRequest, opts ...grpc.CallOption) (*ListDriveClourdreveDirResponse, error)
	// Trash
...
func (c *luminaClient) SyncIndex(ctx context.Context, in *SyncIndexRequest, opts ...grpc.CallOption) (*SyncIndexResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncIndexResponse)
	err := c.cc.Invoke(ctx, Lumina_SyncIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *luminaClient) FullResyncIndex(ctx context.Context, in *FullResyncIndexRequest, opts ...grpc.CallOption) (*FullResyncIndexResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FullResyncIndexResponse)
	err := c.cc.Invoke(ctx, Lumina_FullResyncIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *luminaClient) SetDriveCloudreve(ctx context.Context, in *SetDriveCloudrveRequest, opts ...grpc.CallOption) (*SetDriveCloudrveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetDriveCloudrveResponse)
	err := c.cc.Invoke(ctx, Lumina_SetDriveCloudreve_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *luminaClient) ListDriveCloudrveDir(ctx context.Context, in *ListDriveClourdreveDirRequest, opts ...grpc.CallOption) (*ListDriveClourdreveDirResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDriveClourdreveDirResponse)
	err := c.cc.Invoke(ctx, Lumina_ListDriveCloudrveDir_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LuminaServer interface {
	...
	FullResyncIndex(context.Context, *FullResyncIndexRequest) (*FullResyncIndexResponse, error)
	...
	// Cloudreve Drive
	SetDriveCloudreve(context.Context, *SetDriveCloudrveRequest) (*SetDriveCloudrveResponse, error)
	ListDriveCloudrveDir(context.Context, *ListDriveClourdreveDirRequest) (*ListDriveClourdreveDirResponse, error)
	// Trash
...
func (UnimplementedLuminaServer) SyncIndex(context.Context, *SyncIndexRequest) (*SyncIndexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncIndex not implemented")
}
func (UnimplementedLuminaServer) FullResyncIndex(context.Context, *FullResyncIndexRequest) (*FullResyncIndexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FullResyncIndex not implemented")
}
...
func (UnimplementedLuminaServer) SetDriveCloudreve(context.Context, *SetDriveCloudrveRequest) (*SetDriveCloudrveResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetDriveCloudreve not implemented")
}
func (UnimplementedLuminaServer) ListDriveCloudrveDir(context.Context, *ListDriveClourdreveDirRequest) (*ListDriveClourdreveDirResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDriveCloudrveDir not implemented")
}
...
func _Lumina_SyncIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LuminaServer).SyncIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lumina_SyncIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LuminaServer).SyncIndex(ctx, req.(*SyncIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lumina_FullResyncIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FullResyncIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LuminaServer).FullResyncIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lumina_FullResyncIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LuminaServer).FullResyncIndex(ctx, req.(*FullResyncIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Lumina_SetDriveCloudreve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetDriveCloudrveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LuminaServer).SetDriveCloudreve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lumina_SetDriveCloudreve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LuminaServer).SetDriveCloudreve(ctx, req.(*SetDriveCloudrveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lumina_ListDriveCloudrveDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDriveClourdreveDirRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LuminaServer).ListDriveCloudrveDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lumina_ListDriveCloudrveDir_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LuminaServer).ListDriveCloudrveDir(ctx, req.(*ListDriveClourdreveDirRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Lumina_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Lumina_SyncIndex_Handler,
		},
		{
			MethodName: "FullResyncIndex",
			Handler:    _Lumina_FullResyncIndex_Handler,
		},
		{
			MethodName: "Delete",
		...
		{
			MethodName: "SetDriveCloudreve",
			Handler:    _Lumina_SetDriveCloudreve_Handler,
		},
		{
			MethodName: "ListDriveCloudrveDir",
			Handler:    _Lumina_ListDriveCloudrveDir_Handler,
		},
		{
